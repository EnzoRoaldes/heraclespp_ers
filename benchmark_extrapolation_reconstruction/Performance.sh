...
# Name of the job
#SBATCH --job-name=sgpu_performanceH100_face
...
"256 128 256" "256 256 256" "320 320 320" "256 256 512" "352 352 352")
...
for size in "${SIZES[@]}"; do
    ...
    REPORT_NAME="report_H100_extra_${NX}_${NY}_${NZ}.txt"

    ./$BUILD_DIR/src/nova++ $INI_FILE --extrapolation-reconstruction="base" > "$REPORT_DIR/$REPORT_NAME"
