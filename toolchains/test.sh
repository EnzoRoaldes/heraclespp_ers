...
# nsys profile --trace=cuda,nvtx ./../build_H100/src/nova++ ./../inputs/rayleigh_taylor3d.ini
ncu --nvtx --nvtx-include "dxyz/" --import-source yes --target-processes all --launch-count 100 --set basic -f -o report_H100.ncu-rep ./../build_H100/src/nova++ ./../inputs/rayleigh_taylor3d.ini