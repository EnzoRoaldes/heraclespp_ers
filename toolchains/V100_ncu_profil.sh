...
ncu --nvtx --import-source yes --target-processes all --launch-skip 6 --launch-count 6 --set full --kernel-name-base demangled -k regex:".*LinearReconstruction" -f -o report_V100.ncu-rep ./../build_V100/src/nova++ ./../inputs/rayleigh_taylor3d.ini
