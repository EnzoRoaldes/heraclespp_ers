...
ncu --nvtx --import-source yes --target-processes all --launch-skip 24 --launch-count 24 --set full --nvtx-include "dxyz/" -f -o report_H100.ncu-rep ./../build_H100/src/nova++ ./../inputs/rayleigh_taylor3d.ini