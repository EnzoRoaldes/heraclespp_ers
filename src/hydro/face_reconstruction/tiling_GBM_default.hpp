...
class FaceReconstructionTilingGBMDefault : public IFaceReconstruction
{
...
public:
    explicit FaceReconstructionTilingGBMDefault(SlopeLimiter limiter) 
        : m_slope_limiter(limiter), m_tiling({16, 2, 2}) {}
