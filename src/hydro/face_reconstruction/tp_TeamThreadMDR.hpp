...
class FaceReconstructionTPTTMDR : public IFaceReconstruction
{
...
public:
    explicit FaceReconstructionTPTTMDR(SlopeLimiter limiter, bool enable_timer = false)
        ...
        if (m_enable_timer) {
            ...
            Kokkos::parallel_for(
                ...
                KOKKOS_LAMBDA(const member_type& teamMember) {
                    ...
                    Kokkos::parallel_for(
                        Kokkos::TeamThreadMDRange(teamMember, Ni, Nj),
                        [=] (int i, int j) {
            ...
            std::ofstream timing_file(filename, std::ios::app);if (timing_file) {
                timing_file << "tp_TeamThreadMDR" << " " << ms << " " << dimension[0] << " " << dimension[1] << " " << dimension[2] << "\n";
            }
