...
class FaceReconstructionIdefix : public IFaceReconstruction
{
...
public:
    explicit FaceReconstructionIdefix(SlopeLimiter limiter, bool enable_timer = false) 
