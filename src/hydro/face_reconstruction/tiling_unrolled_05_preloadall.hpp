...
class FaceReconstructionTilingUnrolled05PreloadAll : public IFaceReconstruction
{
...
public:
    explicit FaceReconstructionTilingUnrolled05PreloadAll(SlopeLimiter limiter, bool enable_timer = false) 
        ...
        KV_double_5d const& var_rec) const override
    {
        ...
        if (m_enable_timer) {
            ...
            if (timing_file) {
                timing_file << "tiling_unrolled_05_preloadall" << " " << ms << "\n";
            }
