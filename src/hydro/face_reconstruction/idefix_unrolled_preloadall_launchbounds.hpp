...
class FaceReconstructionIdefixUnrolledPreloadAllLaunchBounds : public IFaceReconstruction
{
...
public:
    explicit FaceReconstructionIdefixUnrolledPreloadAllLaunchBounds(SlopeLimiter limiter, bool enable_timer = false) 
        ...
        KV_double_5d const& var_rec) const override
    {
        ...
        if (m_enable_timer) {
            ...
            if (timing_file) {
                timing_file << "idefix_unrolled_preloadall_launchbounds" << " " << ms << "\n";
            }
