...
class FaceReconstructionTilingGBM : public IFaceReconstruction
{
...
public:
    explicit FaceReconstructionTilingGBM(SlopeLimiter limiter, std::array<int, 3> tiling) 
        : m_slope_limiter(limiter), m_tiling(tiling) {}
