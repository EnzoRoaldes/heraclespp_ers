...
class FaceReconstructionTilingGBMOpti : public IFaceReconstruction
{
...
public:
    explicit FaceReconstructionTilingGBMOpti(SlopeLimiter limiter) 
        : m_slope_limiter(limiter), m_tiling({32, 2, 1}) {}
