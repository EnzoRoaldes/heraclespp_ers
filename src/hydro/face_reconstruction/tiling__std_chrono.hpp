...
class FaceReconstructionTilingStdChrono : public IFaceReconstruction
{
...
public:
    explicit FaceReconstructionTilingStdChrono(SlopeLimiter limiter) 
        ...
        KV_double_5d const& var_rec) const override
    {
        ...
        std::ofstream timing_file("../timing_face_reconstruction_tilin.dat", std::ios::app);
        if (timing_file) 
        {
